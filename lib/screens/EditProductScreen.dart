...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void didChangeDependencies() {
    //it is also changed before builder is executed
      ...
      if (productId != null) {
        ...
        _initvalues = {
          ...
          'price': _editedProduct.price
              .toString(), //we take strings because the formfield oonly work with strings
          'imageUrl': '',
        };
  ...
  Future<void> _saveForm() async {
    ...
    if (_editedProduct.id != null) {
      ...
      //finally{//only works with try and catch and executes its code no matter what 
      // setState(() {
      //   isLoading = false;
      // });
